...
const className = 'CtrScheduleAttribute';
const collectionName = 'schedule_attribute';

class CtrScheduleAttribute {
    ...
    static async add(global, args) {
        ...
        let exist = await Helper.validateIfExist({
            ...
            collectionName,
            params: {
                scheduleAttributeName: args.input.scheduleAttributeName
            }
        });
        if (exist) {
            return {
                status: false,
                message: `The schedule attribute alredy exist!`,
                _id: null
            };
        }
        try {
...
module.exports = CtrScheduleAttribute;